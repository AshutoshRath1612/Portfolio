...
export default function Home() {
  ...
  const setContainerHeight = () => {
    const totalHeight = window.scrollY + window.innerHeight + 100;
  ...
  const animateToHero = () => {
    ...
    if (imageRef.current) {
      waapi.animate(imageRef.current, {
        ...
        position: "static",
        display: "block",
        width: window.innerWidth > 468 && "15rem",
        height: window.innerWidth > 468 && "15rem",
        ease: "inOut(4)",
        duration: 500,
      });
    }
  ...
  const animateToAbout = () => {
    if (imageRef.current && window.innerWidth > 468) {
      waapi.animate(imageRef.current, {
        ...
        position: "fixed",
        display: "block",
        width: window.innerWidth > 768 ? window.innerWidth * 0.25 : "12rem",
        height: window.innerWidth > 768 ? window.innerWidth * 0.25 : "12rem",
        ease: "inOut(4)",
        duration: 2000,
        delay: stagger(100),
      });
  ...
  const slideFooterOut = () => {
    ...
    animate(footerRef.current, {
      ...
      onComplete: () => {
        ...
        const footerContainer = footerRef.current?.querySelector(
          ".footerContainerDiv"
        );
