...
import AnimateWhenView from "../components/Animation/AnimateWhenView";
...
const About = () => {
  ...
  AnimateWhenView(titleRef, () => {
    ...
    // Education section
    AnimateWhenView(educationRef, () => {
      const items = educationRef.current?.querySelectorAll(".educationItem");
      if (items) {
        animate(items, {
          translateY: [50, 0],
          opacity: [0, 1],
    ...
    AnimateWhenView(certRef, () => {
      const items = certRef.current?.querySelectorAll(".certificationItem");
      if (items) {
        animate(items, {
          scale: [0.8, 1],
          opacity: [0, 1],
    ...
    // Skill section
    AnimateWhenView(skillRef, () => {
      const items = skillRef.current?.querySelectorAll(".skillCategory");
      if (items) {
        animate(items, {
          translateX: [-50, 0],
          opacity: [0, 1],
      ...
      <section className={styles.aboutContainer}>
        ...
        <div className={styles.experienceSection}>
          ...
          <div className={styles.experienceList}>
            {personalInfo.experience.map((exp, index) => (
              <div
                key={index}
                className={`${styles.experienceItem} experienceItem`}
              >
        ...
        <div className={styles.educationSection} ref={educationRef}>
          ...
          <div className={styles.educationList}>
            {personalInfo.education.map((edu, index) => (
              <div
                key={index}
                className={`${styles.educationItem} educationItem`}
              >
        ...
        <div className={styles.certificationsSection} ref={certRef}>
          ...
          <div className={styles.certificationsList}>
            {personalInfo.certifications.map((cert, index) => (
              <div
                key={index}
                className={`${styles.certificationItem} certificationItem`}
              >
                <div
        ...
        <div className={styles.skillsSection} ref={skillRef}>
          ...
          <div className={styles.skillsContainer}>
            {Object.entries(personalInfo.skills).map(
              ([category, skills], index) => (
                <div
                  key={index}
                  className={`${styles.skillCategory} skillCategory`}
                >
